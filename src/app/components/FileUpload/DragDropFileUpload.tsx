...
function DragDropFileUploadORIGINAL({ onFileUpload, accept, loading, multiple, disabled, name }: DragDropFileUploadProps) {
...
function DragDropFileUpload({ onFileUpload, accept, loading, multiple, disabled, name, fileToSend, control}: AnyValue) {
  ...
  return (
      ...
      {fileToSend ? <Typography>{fileToSend.name}</Typography> : null}
