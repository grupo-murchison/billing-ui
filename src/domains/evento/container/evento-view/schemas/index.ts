...
export const EventoViewSchema: ZodType<FormDataTypeEventoView> = z.object({
  codigo: z
...
export type FormDataTypeEventoView = {
  codigo: string;
  denominacion: string;
  descripcion: string;
...
export type EventoViewSchemaType = z.infer<typeof EventoViewSchema>;
