      ...
      <DataGrid
        ...
        columns={[
          ...
          },
          {
            ...
            flex: 0.8,
            valueGetter: params => params.row?.contratos[params.row?.contratos.length > 1 ? params.row?.contratos.length -1 : 0]?.contratoClienteCodigo || '',
          },
          {
            field: 'denominación',
            headerName: 'Denominación',
            valueGetter: params => params.row?.contratos[params.row?.contratos.length > 1 ? params.row?.contratos.length -1 : 0]?.contratoClienteDescripcion || '',
          },
          {
            field: 'contratoNro',
            headerName: 'Nro. Contrato',
            flex: 0.9,
            valueGetter: params => params.row?.contratos[params.row?.contratos.length > 1 ? params.row?.contratos.length -1 : 0]?.contratoNumero || '',
          },
          {
            field: 'contratoDescripcion',
            headerName: 'Descripción Contrato',
            flex: 2,
            valueGetter: params => params.row?.contratos[params.row?.contratos.length > 1 ? params.row?.contratos.length -1 : 0]?.contratoDescripcion || '',
          },
          {
            field: 'periodo',
            headerName: 'Período',
            valueGetter: params => params.row?.contratos[params.row?.contratos.length > 1 ? params.row?.contratos.length -1 : 0]?.periodoNumero || '',
            flex: 0.5,
          },
          {
            field: 'actions',
