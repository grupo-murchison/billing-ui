...
import { ProcedimientoPSView } from '@domains/procedimiento-ps/container/procedimiento-ps-view';
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path='/procedimiento-ps/:procedimientoPSId/*' element={<ProcedimientoPSView />} />
      </Route>
